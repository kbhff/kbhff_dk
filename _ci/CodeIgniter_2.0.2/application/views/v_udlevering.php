...
<style type="text/css">
	...
	#subm {
		background-image: url(/img/udlever2.png);
		border: none;
		font-size: 0px;
		color: transparent;
		background-color: transparent;
...
<div id="waiting" style="display: none;"><img src="/img/ajax-loader.gif" alt="Henter..." width="32" height="32" border="0" align="left"> &Oslash;jeblik...</div>
<span id="tt">
...
<span id="afhentet"><?
	foreach ($orderlistcollected as $order)
	{
		if (date("Y-m-d") == $pickupdate)
		{
			echo "<a href=\"/udlevering/annuller/$divisionday/" . $order['uid'] . '" class="but"><img src="/img/del_but2.png" alt="Annuller denne udlevering" title="Annuller denne udlevering" width="15" height="15" border="0"></a> ';
		}
