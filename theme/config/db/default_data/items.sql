...
CREATE TABLE IF NOT EXISTS `kbhff_dk`.`item_membership` (
...
LOCK TABLES `kbhff_dk`.`item_membership` WRITE;
/*!40000 ALTER TABLE `kbhff_dk`.`item_membership` DISABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `kbhff_dk`.`item_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL,
...
LOCK TABLES `kbhff_dk`.`item_message` WRITE;
/*!40000 ALTER TABLE `kbhff_dk`.`item_message` DISABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `kbhff_dk`.`item_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
...
/*!40000 ALTER TABLE `kbhff_dk`.`item_page` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `kbhff_dk`.`item_signupfee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `classname` varchar(100) NOT NULL DEFAULT '',
...
LOCK TABLES `kbhff_dk`.`item_signupfee` WRITE;
/*!40000 ALTER TABLE `kbhff_dk`.`item_signupfee` DISABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `kbhff_dk`.`item_weeklybag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
LOCK TABLES `kbhff_dk`.`item_weeklybag` WRITE;
/*!40000 ALTER TABLE `kbhff_dk`.`item_weeklybag` DISABLE KEYS */;

INSERT INTO `kbhff_dk`.`item_weeklybag` (`id`, `item_id`, `name`, `week`, `year`, `html`, `full_description`)
VALUES
...
/*!40000 ALTER TABLE `kbhff_dk`.`item_weeklybag` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE IF NOT EXISTS `kbhff_dk`.`items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `kbhff_dk`.`items` WRITE;
/*!40000 ALTER TABLE `kbhff_dk`.`items` DISABLE KEYS */;

INSERT INTO `kbhff_dk`.`items` (`id`, `sindex`, `status`, `itemtype`, `user_id`, `created_at`, `modified_at`, `published_at`)
VALUES
	(2,'persondata',1,'page',2,'2018-06-23 00:53:17','2020-02-05 19:11:22','2018-08-16 17:37:00'),
	(3,'velkommen-som-stoettemedlem',1,'message',3,'2018-08-07 20:34:01','2019-04-30 11:43:53','2018-08-07 20:33:01'),
	...
	(7,'stoettemedlem-2',1,'membership',12,'2018-12-20 10:56:34','2020-03-30 13:14:45','2020-03-30 13:14:00'),
	(8,'frivillig-2',1,'signupfee',12,'2018-12-20 10:58:01','2020-03-30 13:28:35','2020-03-30 13:28:00'),
	(9,'allerede-medlem',1,'page',12,'2018-12-20 11:02:44','2018-12-20 18:12:59','2018-12-20 11:02:59'),
	(10,'tilmelding',1,'page',12,'2018-12-20 11:06:27','2018-12-20 11:22:22','2018-12-20 11:06:22'),
	(11,'vaelg-medlemskab',1,'page',12,'2018-12-20 11:10:00','2020-01-13 18:17:09','2018-12-20 11:10:00'),
	(12,'afdelinger-i-kbhff',1,'page',2,'2019-07-05 20:59:11','2019-12-15 17:32:13','2019-07-05 20:59:00'),
	(18,'for-leverandoerer',1,'page',21,'2019-07-13 19:40:00','2019-12-15 18:41:55','2019-07-13 19:40:00'),
	(20,'handelsbetingelser',1,'page',21,'2019-07-13 19:43:59','2020-01-13 19:06:11','2019-07-13 19:43:00'),
	(118,'uge-2',1,'weeklybag',21,'2020-02-15 15:24:35','2020-02-17 20:13:56','2020-02-17 20:13:00'),
	(121,'uge-3',1,'weeklybag',21,'2020-02-18 20:59:14','2020-02-18 21:02:13','2020-02-18 21:02:00'),
	(122,'uge-4',1,'weeklybag',21,'2020-02-18 21:03:04','2020-02-18 21:06:50','2020-02-18 21:06:00'),
	(123,'uge-5',1,'weeklybag',21,'2020-02-18 21:07:23','2020-02-18 21:09:12','2020-02-18 21:09:00');

/*!40000 ALTER TABLE `kbhff_dk`.`items` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE IF NOT EXISTS `kbhff_dk`.`items_prices` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL,
...
LOCK TABLES `kbhff_dk`.`items_prices` WRITE;
/*!40000 ALTER TABLE `kbhff_dk`.`items_prices` DISABLE KEYS */;
