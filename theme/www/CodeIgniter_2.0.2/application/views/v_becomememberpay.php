...
<img src="/img/dankort.gif" alt="Du kan betale med Visa/Dankort eller Dankort" title="Du kan betale med Visa/Dankort eller Dankort">
<br clear="all">
...
<input type="hidden" name="TunnelURL" value="https://<?= getenv("SERVER_NAME") ?>/pay/pay4">
