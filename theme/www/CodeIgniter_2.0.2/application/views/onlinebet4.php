...
<img src="https://pay.dandomain.dk/securetunnel-bin.asp?url=https://<?= getenv("SERVER_NAME") ?>/img/banner.jpg" alt="K&oslash;benhavns F&oslash;devare F&aelig;llesskab" width="800" height="188" border="0">
...
$sOKURL = "https://".getenv("SERVER_NAME")."/pay/ok/$SessionID/$memberurl"; // Returnerer hvis indbetalingen gik godt
$sFAILURL = "https://".getenv("SERVER_NAME")."/pay/fail/"; // Returnerer hvis inbetalingen fejlede
?>
...
<table width="550" border="0" cellspacing="1" cellpadding="4">
	...
	<br><br>
  	...
  	<tr> 
    <td  colspan="2"><img src="https://pay.dandomain.dk/img/kort-dankort.gif" border="0">
...
Din browser skal vise en h&aelig;ngel&aring;s som bevis p&aring; SSL-kryptering: <img src="https://pay.dandomain.dk/securetunnel-bin.asp?url=https://<?= getenv("SERVER_NAME") ?>/img/ssl_indicator.gif" alt="SSL Kryptering" width="12" height="15" border="0" align="middle"></p>
<br>
