				...
				?>
					...
					<div class="order_items">
						...
						<div class="order_item">
							...
							<ul class="actions change"><li class="change"><a href="/butik/ret-bestilling/<?= $order_item["id"] ?>" class="button <?= date("Y-m-d") > date("Y-m-d", strtotime($pickupdate["pickupdate"]." - 1 week")) ? "disabled" : "" ?>">Ret</a></li></ul>
						</div>
						<? endforeach; ?>
					</div>
					<? endif; ?>
