	...
	<div class="item i:defaultEdit">
		...
		<?= $model->formStart("update/".$item["id"], array("class" => "labelstyle:inject")) ?>
			...
			<fieldset>
				...
				<?= $model->input("associated_member_id", array("type" => "select", "options" => $HTML->toOptions($memberships, "id", "name", ["add" => ["" => "Choose associated membership type"]]), "value" => $item["associated_membership_id"])) ?>
