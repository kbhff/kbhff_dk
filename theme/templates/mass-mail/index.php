	...
	<div class="c-wrapper">
		<div class="c-one-half">
			...
			<div class="c-box">
				...
				<p>De to øverste felter er til beskedens emne og mailprogrammets forhåndsvisning. Herunder begynder selve mail-editoren. Bemærk bogstavet 'P' i venstre side af tekstfeltet.</p>
				...
				<p>Hvis du skal bruge punktopstilling, kan du trykke på plus-symbolet, der dukker op i højre side, når du holder musen over et felt. Vælg derefter 'List'. Du har nu i venstre side mulighed for at vælge UL ('unordered list') for almindelige punkttegn eller OL ('ordered list') for nummererede punkttegn.</p>
