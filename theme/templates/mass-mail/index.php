	...
	<div class="c-wrapper">
		<div class="c-one-half">
			...
			<div class="c-box">
				...
				<p>De to øverste felter til beskedens er til beskedens emne og til mailprogrammets forhåndsvisning. Herunder begynder selve mail-editoren. Bemærk, det grønne 'P' i venstre side.</p>
				...
				<p>Hvis du skal bruge punktopstilling, kan du trykke på det grønne plus-symbol, der dukker op i højre side, når du holder musen over et felt, og vælge 'List'. Du har nu i venstre side mulighed for at vælge UL ('unordered list') for almindelige punkttegn eller OL ('ordered list') for nummererede punkttegn.</p>
