...
<? } else { ?>
	<link type="text/css" rel="stylesheet" media="all" href="/css/seg_<?= $this->segment() ?>.css?rev=20201117-234256" />
	<script type="text/javascript" src="/js/seg_<?= $this->segment() ?>.js?rev=20201117-234256"></script>
<? } ?>
