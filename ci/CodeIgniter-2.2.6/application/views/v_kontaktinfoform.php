...
<?php if ($admin) { ?>
				<li>
					...
					<select name="active" class="memberform_select">
						...
						<option value="paid"<?php if ($active === 'paid') echo ' selected="selected"'; ?>>Betalt</option>
						<option value="no"<?php if ($active === 'no') echo ' selected="selected"'; ?>>Passiv</option>
					</select>
					<div id="form_remarks">Betalt betyder at medlemmet er aktivt, og har betalt kontingent. Aktiv er koden for medlemmer der ikke har betalt kontingent endnu. Passiv betyder, at medlemmet ikke kan bestille, og heller ikke forventes at tage vagter.<br>
