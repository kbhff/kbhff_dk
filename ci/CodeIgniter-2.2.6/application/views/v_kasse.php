...
<?= $medlemordreliste ?>
<br>
<table><tr valign="top"><td valign="top">Registrer ordrer (kontant/mobilepay):<br>
<?= $cashsel ?>
</td><td valign="top"><form action="/kontantordrer/annuller" method="post">Annuller kontant/mobilepay-ordre:<br>
Ordrenr.: <input type="text" name="orderno" size="5" maxlength="5"> <input type="submit" value="Annuller" class="form_button">
</form></td></tr>
<tr><td valign="top"><a href="/blivmedlem/index/<?= $this->session->userdata('uid') ?>">Registrering af kontant/mobilepay-indmelding af nyt medlem</a></td><td valign="top">&nbsp;</td></tr>
